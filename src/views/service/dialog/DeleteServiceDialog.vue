<template>
  <RdappDialog
    ...
    width="520px"
    :show-footer="true"
    custom-class="delete-service-dialog"
    @close="handleClose"
  >
    <template #header>
      <div class="modal-header">
        <span class="header-title">删除服务</span>
      </div>
    </template>
    ...
    <div class="modal-body">
      ...
      <div class="content-wrapper">
        <h4 class="warning-title">确认删除 {{ serviceName }} 相关文档?</h4>
        <p class="warning-desc">
          删除后，该服务的配置信息及所有历史版本文档都将被永久移除，此操作不可撤销。
        </p>
      </div>
    </div>
